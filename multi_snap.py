...
### Others
fields = ['nh', 'temp']
sim, snap_init, snap_final, img_size = 'nahw1', 1, 136, 100
...
### MRT
#fields = ['nh', 'phodens']
sim, snap_init, snap_final, img_size = 'nahw1r4rt1', 1, 1, 10
...
for snaps in np.arange(snap_init, snap_final+1):
   ...
   pc.savefig('/n/home02/fbecerra/pacha_new/images/multi_snap_RTPH_'+sim+'_'+'_'.join(fields)+'_'+str(img_size)+'pc_%03i.pdf' %snaps)
end_total = time.time()
