...
radial_fields_list  = ['enc_mass', 'sigma_gas', 'geff', 'dnh', 'vrad', 'vrot', 'vturb', 'omega_rot', 'vkep', 'q', 'radial_esc_frac', 'radial_cool_rate', 'radial_tcool_ratio', 'mbe_ratio', 'gammie', 'infall'] 
